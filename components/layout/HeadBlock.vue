...
const clickMainMenuItem = () => props.clickMainMenuItem();
</script>
    ...
    <header class="header">
        <nav class="header__container">
            ...
            <LayoutMenu 
                ...
                :isVisibleForMenu="visibleMenu"
            />
        </nav>
        <span>{{ $attrs.test }}</span>
        <a href="#countries" class="header__button" @click="$emit('clickButton', first)">Купить</a>
    </header>
    <slot />
</template>
